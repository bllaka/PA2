...
- __First part__ is finding best fundamental matrix with RANSAC. (fundamental_m.py)
- __Second part__ is Triangulation 2D point coordinates to 3D point coordinate. (triangulation.py)
